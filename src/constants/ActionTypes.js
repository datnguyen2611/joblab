...
//Auth const
export const REQUESTED_INIT_USER = 'REQUESTED_INIT_USER';
...
//List const
export const REQUESTED_INIT_LIST = 'REQUESTED_INIT_LIST';
export const INIT_LIST = 'LIST';
export const INIT_LIST_SUCCESS = 'INIT_LIST_SUCCESS';
export const INIT_LIST_FAILED = 'INIT_LIST_FAILED';

export const REQUESTED_INIT_COUNTRY = 'REQUESTED_INIT_COUNTRY';
export const INIT_COUNTRY = 'COUNTRY';
export const INIT_COUNTRY_SUCCESS = 'INIT_COUNTRY_SUCCESS';
export const INIT_COUNTRY_FAILED = 'INIT_COUNTRY_FAILED';

export const REQUESTED_INIT_INDUSTRY = 'REQUESTED_INIT_INDUSTRY';
export const INIT_INDUSTRY = 'INDUSTRY';
export const INIT_INDUSTRY_SUCCESS = 'INIT_INDUSTRY_SUCCESS';
export const INIT_INDUSTRY_FAILED = 'INIT_INDUSTRY_FAILED';

export const REQUESTED_INIT_JOBTYPE = 'REQUESTED_INIT_JOBTYPE';
export const INIT_JOBTYPE = 'JOBTYPE';
export const INIT_JOBTYPE_SUCCESS = 'INIT_JOBTYPE_SUCCESS';
export const INIT_JOBTYPE_FAILED = 'INIT_JOBTYPE_FAILED';

export const REQUESTED_INIT_DIALCODE = 'REQUESTED_INIT_DIALCODE';
export const INIT_DIALCODE = 'DIALCODE';
export const INIT_DIALCODE_SUCCESS = 'INIT_DIALCODE_SUCCESS';
export const INIT_DIALCODE_FAILED = 'INIT_DIALCODE_FAILED';

export const REQUESTED_INIT_COMPANY = 'REQUESTED_INIT_COMPANY';
export const INIT_COMPANY = 'COMPANY';
export const INIT_COMPANY_SUCCESS = 'INIT_COMPANY_SUCCESS';
export const INIT_COMPANY_FAILED = 'INIT_COMPANY_FAILED';

//Upload CV const
export const REQUESTED_UPLOAD_CV = 'REQUESTED_UPLOAD_CV';
export const UPLOAD_CV = 'CV';
