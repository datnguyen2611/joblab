...
class Header extends Component {
  ...
  onAppNotificationSelect = () => {
    ...
    if (!this.state.appNotifIsOpen) {
      ...
      var data = {};
      axios.post("/api/users/get/notification", data).then((res) => {
      ...
      axios
        .post("/api/users/set/notification/ack", data)
        .then((res) => {
          if (res.data.isSuccess) {
  ...
  */
  ...
  updateNotificationCount() {
    ...
    socket.on("getNotificationCount", (count) => {
      ...
      <IntlProvider locale="en">
        <AppBar
          ...
          className={`app-main-header ${
            navigationStyle ===
            HORIZONTAL_NAVIGATION /*&& horizontalNavPosition === BELOW_THE_HEADER*/
              ? "transparent"
              : ""
          }`}
        >
          <Container>
            ...
            <IconButton className={`jr-menu-icon mr-3 ${drawerStyle}`} aria-label="Menu"
              ...
              <Link className="app-logo mr-2" to="/">
                <img
                  src={JOBSLAB_ICON_URL + "jobslab_white.png"}
                  alt="Jobslab"
                  title="Jobslab"
                />
              </Link>
            ...
            />
              ...
              <div
                className="d-block d-lg-none d-md-none pointer mr-3"
                onClick={this.onToggleCollapsedNav}
          ...
          <Menu /> */}
              ...
              <i class="fas fa-chevron-right"></i>
                  ...
                  <div className="auth-bar__btn-group">
                    <Button
                      className="auth-bar__login jr-btn text-white mr-1 mr-md-2"
                    ...
                    <Button
                      variant="contained"
                      className="auth-bar__CV jr-btn bg-success text-white mr-2"
                          ...
                          <i
                            className={
                              this.state.notificationCount > 0
                                ...
                                : "zmdi zmdi-notifications-none wobble"
                            }
                          />
                        </IconButton>
                      </DropdownToggle>
