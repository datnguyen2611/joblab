      ...
      <AppBar id="header-bar" style={{'width':this.state.headerWidth, backgroundColor:(navigationStyle === HORIZONTAL_NAVIGATION)? this.state.headerColor:null}}
        ...
        <Toolbar className="app-toolbar" disableGutters={false}>
          ...
          <div className="auth-bar">
            ...
            <Button className="jr-btn text-white mr-1 mr-md-2" onClick={() => this.openModal('login')}>
              {/*<i className="la la-external-link-square"></i>*/}
              Login
            </Button> 
            <Button variant="contained" className="jr-btn bg-success text-white mr-0 mr-md-2" onClick={() => this.openModal('signup')}>
