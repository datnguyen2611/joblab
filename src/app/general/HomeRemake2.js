...
class Home extends Component {
  ...
  openSignupModal1 = () => {
    this.setState({ signupModalIsOpen: false, loginModalIsOpen: true });
  };
    ...
    return (
      <div className="home-wrapper">
                  ...
                  <Grid item xs={12} lg={5} style={{ padding: 40 }}>
                    <div>
                      ...
                      <div className="css-k008qs">
                        <Button variant="contained" style={{ marginRight: 10 }}  onClick={() => this.openSignupModal1()} >
                          Sign up for free
                        </Button>
            ...
            <div className="css-1g440lb">
              <Container>
                <div className="css-e6zcug">
                  <div
                    className="ui fluid raised card css-1wuptrb"
                          ...
                          <div className="MuiGrid-root MuiGrid-container MuiGrid-align-items-xs-center">
                            <div className="MuiGrid-root MuiGrid-item MuiGrid-grid-xs-12 MuiGrid-grid-md-6">
                              <div className="css-1py1l5l">
                                <div className="css-ta7fyc">
                                  ...
                                  >
                                    <span
                                      className="css-nudg5n"
                                      style={{ fontSize: 20, fontWeight: 300 }}
                                    >
                                      1 A Fintech powerhouse leveraged Snaphunt
                                      for remote hiring across South East Asia
                                      while
                                    </span>{" "}
                            ...
                            <div className="MuiGrid-root MuiGrid-item MuiGrid-grid-xs-12 MuiGrid-grid-md-6">
                              <div className="css-1ftvkz8">
                                <div className>
                                  <p
                                    className="css-rmhymj e56oal20"
                                    style={{ fontSize: 16, fontWeight: 300 }}
                                  >
                                    With limited in-house HR resources, this
                                    Fintech used Snaphunt to efficiently
                                    generate dozens of job descriptions, source
                                    for open roles across a number of channels
                                    using while also receiving quality matches
                                    from Snaphunt’s talent pool.
                                  </p>
                                  <p
                                    className="css-rmhymj e56oal20"
                                    style={{ fontSize: 16, fontWeight: 300 }}
                                  >
                                    Their regional teams could also easily
                                    collaborate and share feedback on each
                                    candidate at every stage. This helped them
                                    stay aligned and make their hires quickly
                                    &amp; accurately.
                                  </p>
                                </div>
                              </div>
                    ...
                    <div className="content css-jrzc9f">
                      <div className="css-1u9juce">
                        <Slider {...settings1}>
                          <div className="item">
                            <img
                              src="https://images.snaphunt.com/assets/images/logos/h_50/mazars.jpeg"
                              alt="mazars llp logo"
                              className="css-6kk5wx"
                            />
                          </div>
                          <div className="item">
                            <img
                              src="https://images.snaphunt.com/assets/images/logos/h_50/f8.jpeg"
                              alt="f8 innovation logo"
                              className="css-6kk5wx"
                            />
                          </div>
                          <div className="item">
                          ...
                          <div className="content">
                            ...
                            <div className="css-1q7njkh">
                              ...
                              <p className="css-1e7vlpv">
                                ...
                                ultimately hire a number of talented individuals
                                at a fraction of the cost and time of
                                traditional recruitment agencies. Snaphunt is
                                now one of our key partners, as we look to build
                                a high performing team across Asia.
                              </p>
        ...
        <SignupForm
          ...
          closeModal={() => this.closeModal("signupModalIsOpen")}
        />
        <LoginForm
          isOpen={this.state.loginModalIsOpen}
          openSignupModal={this.openSignupModal}
          closeModal={() => this.closeModal("loginModalIsOpen")}
        />
      </div>
    );
  }
